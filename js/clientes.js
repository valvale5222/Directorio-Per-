...
const agroNoAgroYear = {
  years:  [2021, 2022, 2023, 2024, 2025, 2026],
  agroN:    [44, 43, 35, 35, 42, 40],
  agroV:    [19069613, 32200684, 14125312, 14055896, 33904143, 28027727],
  noagroN:  [11, 8, 6, 10, 7, 8],
  noagroV:  [1240928, 999081, 1164063, 1394813, 1052181, 1070341]
};
